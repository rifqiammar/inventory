<div class="page-inner">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#LapBrgKlr">
				...
				<div class="modal fade" id="LapBrgKlr" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form target="_blank" method="POST" action="cetakBrgKlr.php">
