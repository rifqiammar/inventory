						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
										<center><h4 class="card-title">Laporan Barang Masuk</h4></center>
								</div>
								<div class="card-body">
										...
										<table class="display table table-bordered" >
											...
											<tbody>
												...
												<?php
													...
													$c = mysqli_query($conn,"select * from brgmsk inner join barang on brgmsk.id_brg=barang.id_brg and tglmsk between '$tgl_awal' and '$tgl_selesai'");
												}else{
													$c = mysqli_query($conn,"select * from brgmsk");
												}
