	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="#" class="logo">
					<img src="../assets/img/images.jpg" style="width: 40px;height: 40px;" alt="navbar brand" class="navbar-brand">
				...
				<div class="sidebar-content">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									<span class="user-level">Gudang</span>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-section">
							...
							<h4 class="text-section">Data Component</h4>
						</li>
						<li class="nav-item">
							<a href="?view=brgmsk">
		...
		<div class="main-panel">
			<div class="content">
				<?php
					...
					// Data Component
					elseif($_GET['view']=='brgmsk')
						include 'brgmsk.php';
					elseif($_GET['view']=='addbrgmsk')
						include 'addbrgmsk.php';
					elseif($_GET['view']=='tmbstok')
						include 'tmbstok.php';

					elseif($_GET['view']=='brgklr')
						include 'brgklr.php';
					elseif($_GET['view']=='addbrgklr')
						include 'addbrgklr.php';
					elseif($_GET['view']=='klrstok')
						include 'klrstok.php';
				 ?>
			</div>
			<footer class="footer">
